...
class V2RayVpnService :
    ...
    /**
     * destroy Unfortunately registerDefaultNetworkCallback is going to return our VPN interface:
     ...
     * Unfortunately we need to have android.permission.CHANGE_NETWORK_STATE to be able to call
     * requestNetwork.
     *
     * Source:
    ...
    private fun setup() {
        ...
        Utils.getVpnDnsServers().forEach {
